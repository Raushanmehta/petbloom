...
export default function BlogCard({ blog }: BlogCardProps) {
    return (
        <motion.article
            ...
            className="group flex flex-col items-center gap-6 rounded-[1rem] border border-gray-100/90 bg-white p-2 shadow-lg shadow-gray-100 sm:flex-row">

            <div className="relative h-[160px] w-full shrink-0 overflow-hidden rounded-2xl shadow-sm sm:h-[170px] sm:w-[200px]">
                <Image
                    src={blog.image}
                    alt={blog.title}
                    fill
            ...
            <div className="flex w-full flex-grow flex-col justify-between px-4 py-4">
                ...
                <motion.div
                    ...
                    <Link
                        href={`/blog/${blog.id}`}
                        className="inline-flex items-center gap-1.5 text-xs font-bold text-[#387478] transition-colors hover:text-[#2d5d61]">
                        Read More
