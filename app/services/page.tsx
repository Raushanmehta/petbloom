...
import { cardVariant, teamCardsContainerVariants, teamFadeUpVariants, teamHeaderContainerVariants } from "@/utils/animations";
...
const { servicesData, servicesPageData } = data as {
    servicesData: ServiceItem[];
    servicesPageData: SectionHeaderData;
};
        ...
        <main>
            ...
            <section className="relative overflow-hidden bg-[#FCF7F3] px-4 py-20 sm:px-6 lg:px-12">
                ...
                <motion.div
                    ...
                    <motion.h2
                        variants={teamFadeUpVariants}
                        className={`${lilitaOne.className} mx-auto mt-4 max-w-2xl text-center text-4xl tracking-wide text-gray-900 sm:text-5xl lg:text-6xl`}
                    >
                        {servicesPageData.titleWhite}
                        <span className="text-[#E67E22]">
                            {servicesPageData.titleColored}
                        </span>
                    </motion.h2>
