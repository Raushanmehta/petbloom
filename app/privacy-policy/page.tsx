...
export default function PrivacyPolicyPage() {
    const pageData = (data as unknown as { privacyPolicyData: PrivacyPolicyDataWrapper }).privacyPolicyData;

    return (
        <main>
            <PageTopSection
                title={pageData.pageData.titleColored || "Privacy Policy"}
                subTitle={pageData.pageData.badgeText || "Privacy Policy"}
            />
                ...
                <div className="mx-auto max-w-[1300px]">
                    ...
                    <motion.div
                        ...
                        <motion.h2
                            ...
                            {pageData.pageData.titleWhite} {""}
                            <span className="text-[#E67E22]">
                                {pageData.pageData.titleColored}
                            </span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            {pageData.introDescription || pageData.pageData.description}
                        </motion.p>
