                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <div className="flex items-center gap-2.5">
                                    <motion.div
                                        ...
                                        <FaPaw className="h-7 w-7 sm:h-8 sm:w-8 text-[#E67E22]" />
                                    </motion.div>
                                    <span className={`${lilitaOne.className} text-2xl sm:text-3xl tracking-wide text-gray-900`}>
                                        {pageData?.brandStart || "Pet"}{" "}
                                        <span className="text-[#E67E22]">{pageData?.brandEnd || "Bloom"}</span>
                                    </span>
                                </div>

                                <h1 className={`${lilitaOne.className} text-3xl sm:text-5xl lg:text-6xl tracking-wide text-gray-900 leading-tight`}>
                                ...
                                {/* Divider */}
                                <div className="mx-auto mt-3 sm:mt-4 flex items-center justify-start gap-3 sm:gap-4">
                                    <motion.div
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-xs font-medium text-gray-600 leading-relaxed break-words">
                            ...
                            <motion.div
                                ...
                                <h3 className={`${lilitaOne.className} text-xl sm:text-2xl tracking-wide text-gray-900`}>
                                ...
                                <motion.div
                                    ...
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                    className="flex items-center flex-wrap gap-2.5 sm:gap-3 pt-1">
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                <Link
                                                    ...
                                                    className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-[#387478] hover:text-white transition-all shadow-sm">
                        ...
                        <motion.div
                            ...
                            <div className="text-center mb-6 sm:mb-8 space-y-2 sm:space-y-3">
                                ...
                                {/* Divider */}
                                <div className="mx-auto mt-3 sm:mt-4 flex items-center justify-center gap-3 sm:gap-4">
                                    <motion.div
                                        initial={{ width: 0, opacity: 0 }}
                                        whileInView={{ width: 48, opacity: 1 }}
                                        viewport={{ once: true }}
